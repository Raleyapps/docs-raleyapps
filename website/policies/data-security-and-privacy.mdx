...
This statement describes the data access, handling, and storage practices for all Raley add-ons. _Effective: November 4, 2022._
...
- Configuration data (including SMTP or Slack credentials if configured) — backed up for 30\+ days
