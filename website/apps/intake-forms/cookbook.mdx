---
title: "Raley Intake Forms cookbook of common configurations"
description: "Step-by-step recipes for common Raley Intake Forms tasks: CSS branding, field validation rules, JIFF dropdown filters, and other frequent setup scenarios."
last_reviewed: "2026-05-19"
---

## Overview

The Cookbook contains step-by-step solutions to the most common Intake Forms configuration tasks. Each recipe addresses a specific problem so you can find exactly what you need quickly.
...
### Customizing the Look and Feel of Intake Forms
...
### Raley Intake Forms Filters (JIFF)
