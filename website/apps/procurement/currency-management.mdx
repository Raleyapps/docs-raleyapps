---
title: "Configure default currency for purchase orders in Jira"
description: "Set the default currency that Raley Procurement for Jira & JSM uses for budget calculations, why it must be defined before creating orders, and how to change it safely."
---

## Overview

Raley Procurement for Jira & JSM uses a **Default Currency** as the baseline for all budget calculations. When orders are placed in other currencies, exchange rates apply — but all budget statistics are displayed in the Default Currency.
