...
description: "Set the default currency that Raley Purchase Orders uses for budget calculations, why it must be defined before creating orders, and how to change it safely."
---
