---
title: "Configure tax rates for purchase orders in Jira"
description: "Define multiple tax rates such as VAT or sales tax in Raley Purchase Orders, set the default rate, and apply taxes automatically to products and order lines."
---
