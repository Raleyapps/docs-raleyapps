---
title: "Raley Procurement for Jira & JSM security release — June 2022"
description: "Security release notes for Raley Procurement for Jira & JSM v1.0.12-AC, June 2022: vulnerabilities identified, fixes shipped, affected components, and upgrade guidance."
---

## Summary

In May 2022, RaleyApps enrolled in the **Bugcrowd** security testing program. During testing, two vulnerabilities were identified in Raley Procurement for Jira & JSM version 1.0.11-AC. Both were resolved in **version 1.0.12-AC**, released June 30, 2022.
