---
title: "Raley Procurement for Jira & JSM Log4Shell patch — December 2021"
description: "Security release notes for Raley Procurement for Jira & JSM December 2021: CVE-2021-44228 Log4Shell patch, affected versions, and required upgrade steps for customers."
---

## Summary

On December 13, 2021, Atlassian security testing identified a critical vulnerability in the Raley Procurement for Jira & JSM AppServer related to **CVE-2021-44228** (log4j Remote Code Execution, also known as Log4Shell).
...
A specially crafted HTTP request could have exploited the log4j vulnerability on the Raley Procurement for Jira & JSM AppServer.
