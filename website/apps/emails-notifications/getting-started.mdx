---
title: "Set up your first email notification rule in Jira Cloud"
description: "Install Raley Emails Notifications, connect a sending account, and create your first notification rule that sends a custom email when a Jira issue changes."
